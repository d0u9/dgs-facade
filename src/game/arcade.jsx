...
const GAMES = [
  ...
  { slug: 'minesweeper', title: 'Minesweeper', code: '03', blurb: 'Clear the field with logic. Mark every hidden mine.', keys: 'CLICK / TAP · LONG PRESS TO FLAG' },
  { slug: 'snake', title: 'Snake', code: '04', blurb: 'Collect the glowing cells without crossing your own trail.', keys: 'ARROWS / WASD', href: '/arcade/snake/' },
  { slug: 'hextris', title: 'Hextris', code: '05', blurb: 'Rotate the hexagon. Match three colors before the stack reaches the edge.', keys: '← → / A D · SPACE' },
  { slug: 'dino', title: 'Chrome Dino', code: '06', blurb: "Open Chrome's built-in offline runner.", keys: 'COPY URL · OPEN FROM ADDRESS BAR', href: '/arcade/dino/' },
  { slug: 'battleship', title: 'Battleship', code: '07', blurb: 'Find the hidden fleet before the opponent sinks yours.', keys: 'CLICK / TAP TO FIRE' },
  { slug: 'tetris', title: 'Tetris', code: '08', blurb: 'Stack falling pieces. Clear full rows before the well fills up.', keys: '← → ↓ · ↑ ROTATE · SPACE' },
  { slug: 'flappy', title: 'Flappy Bird', code: '09', blurb: 'Flap through the gaps. One touch is all the control you get.', keys: 'SPACE / CLICK / TAP' },
